...
if PO_TOKEN:
    ...
    _YTDLP_AUTH = ["--cookies", COOKIES_FILE, "--extractor-args", "youtube:player_client=web"]
else:
    _YTDLP_AUTH = ["--extractor-args", "youtube:player_client=web;js_runner=deno", "--throttled-rate", "100"]
...
class MusicController:
    ...
    async def _sequential_preload(self):
        for track in list(self.queue[:10]):
