...
# ==========================================================
# 2. Import Flask app & Firebase (absolute dari root)
# ==========================================================
...
# ==========================================================
# 7. Stats Updater Loop (30s) — NOW WITH guilds_list
# ==========================================================
...
async def update_stats():
    try:
        ...
        # ── Guilds List (for sidebar dropdown) ──
        guilds_list = [
            {
                "id":           str(g.id),           # ← HARUS string untuk Jinja2
                "name":         g.name,
        ...
        # ── Sync text channels per guild (for welcome dropdown) ──
        for guild in bot.guilds:
            text_channels = [
...
# ==========================================================
# 8. on_ready — Load Cogs & Start Loops
# ==========================================================
@bot.event
async def on_ready():
    print("=" * 50)
